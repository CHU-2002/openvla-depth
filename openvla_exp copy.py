...
local_model_path = "/mnt/disk4/yitong/changedcafathha/31f090d05236101ebfc381b61c674dd4746d4ce0+ur5_robo_dataset+b8+lr-0.0001+lora-r32+dropout-0.0--image_aug--25000_chkpt"
...
def main():
    ...
    try:
        while True:
            ...
            inputs = processor(prompt, image_pil, return_tensors="pt").to("cuda:0", dtype=torch.bfloat16)
