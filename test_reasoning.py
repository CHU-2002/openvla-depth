...
local_model_path = "/mnt/second_drive/home/31f090d05236101ebfc381b61c674dd4746d4ce0+ur5_robo_dataset+b8+lr-0.0001+lora-r32+dropout-0.0--image_aug--25000_chkpt"
...
for i in range(150):
    ...
    np.set_printoptions(threshold=np.inf)  # 设置为无穷大，防止省略
    # print(dep_primary_image)
