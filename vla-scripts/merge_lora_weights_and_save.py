...
def main(cfg: ConvertConfig) -> None:
    ...
    print(vla.__class__)
    print(vla.forward.__code__.co_filename)
    processor = AutoProcessor.from_pretrained(cfg.base_checkpoint, trust_remote_code=False)
    processor.save_pretrained(cfg.lora_finetuned_checkpoint_dir)
