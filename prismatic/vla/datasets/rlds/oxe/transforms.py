...
def ur5_dataset_transform(trajectory: dict) -> dict:
    """
    Relable action, remove the last step, rename EEF_state
    """
    ...
    trajectory = relabel_ur5_actions(trajectory)
    trajectory["observation"]["EEF_state"] = trajectory["observation"]["pose"][:, :6]
    trajectory["observation"]["gripper_state"] = tf.expand_dims(trajectory["observation"]["gripper"], axis=-1)
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "ur5_robo_dataset":ur5_dataset_transform,
}
